...
import { ChevronLeft, ChevronRight, Play, Pause, Baby, Heart, Users, Clock, Eye, Camera, Trophy, Zap, Target, Volume2, VolumeX, Share2, Download, ExternalLink } from "lucide-react";

export default function SoftplayTrampolineBullrideGallery({ galleryImages, videos, metrics }) {
  ...
  const fallbackImages = [
    {
      src: "https://cdn.acsdev.in/FNF/69e9c7ffb576b.jpg",
      alt: "Children playing in colorful softplay area with slides and climbing frames",
      title: "Softplay Adventure",
      category: "Softplay",
      likes: 285,
      type: "image"
    },
    {
      src: "https://cdn.acsdev.in/FNF/69e9c6a6d6d8f.jpg",
      alt: "Kids bouncing on trampolines with safety nets",
    ...
    {
      src: "https://cdn.acsdev.in/FNF/69e9c6a569365.jpg",
      alt: "Mechanical bull ride with safety mats and cheering crowd",
      title: "Bull Ride Challenge",
      category: "Bull Ride",
      likes: 198,
      type: "image"
    },
    {
      src: "https://cdn.acsdev.in/FNF/69e9c7ffb576b.jpg",
      alt: "Birthday party celebration in the play area",
    ...
    {
      src: "https://cdn.acsdev.in/FNF/69e9c6a6d6d8f.jpg",
      alt: "Family enjoying activities together in the fun zone",
      title: "Family Time",
      category: "Family",
      likes: 312,
      type: "image"
    ...
    {
      src: "https://cdn.acsdev.in/FNF/69e9c6a569365.jpg",
      alt: "Safe and clean play equipment with supervision",
      title: "Safety First",
      category: "Safety",
      likes: 189,
      type: "image"
  ...
  const categories = ["Softplay", "Trampoline", "Bull Ride", "Events", "Family", "Safety"];
  const titles = [
    "Softplay Adventure",
    "Trampoline Fun",
    "Bull Ride Challenge",
  ...
  const processedVideos = React.useMemo(() => {
    // console.log('Processing videos in SoftplayTrampolineBullrideGallery:', videos);

    if (videos && videos.length > 0) {
      return videos.map((video, index) => {
        const baseVideo = {
          alt: `Family fun video ${index + 1}`,
          title: video.label && video.label[0] ? video.label[0] : `Fun Video ${index + 1}`,
          category: categories[index % categories.length],
          likes: Math.floor(Math.random() * 200) + 150,
  ...
  // Dynamic metrics data with fallbacks
  const metricsData = React.useMemo(() => {
    const fallbackMetrics = [
      { value: "15+", label: "Fun Activities", color: "red" },
      { value: "3000+", label: "Happy Families", color: "amber" },
      { value: "All Day", label: "Fun Duration", color: "orange" },
      { value: "100%", label: "Family Fun", color: "red" }
    ];
  ...
  return (
    <section id="SoftplayTrampolineBullrideGallery" className="relative bg-[#1e2125] text-white py-16 px-4 sm:px-6 md:px-10 lg:px-20 overflow-hidden">

      {/* Gallery Background Decorations */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Photo Frame Corners */}
        <div className="absolute top-20 left-20 opacity-10">
          <svg width="40" height="40" viewBox="0 0 40 40" className="text-white/30">
            <path d="M0 0 L15 0 M0 0 L0 15" stroke="currentColor" strokeWidth="3" fill="none"/>
            <path d="M40 0 L25 0 M40 0 L40 15" stroke="currentColor" strokeWidth="3" fill="none"/>
            <path d="M0 40 L15 40 M0 40 L0 25" stroke="currentColor" strokeWidth="3" fill="none"/>
            <path d="M40 40 L25 40 M40 40 L40 25" stroke="currentColor" strokeWidth="3" fill="none"/>
          </svg>
        </div>

        <div className="absolute top-20 right-20 opacity-10">
          <svg width="40" height="40" viewBox="0 0 40 40" className="text-red-500/30">
            <path d="M0 0 L15 0 M0 0 L0 15" stroke="currentColor" strokeWidth="3" fill="none"/>
            <path d="M40 0 L25 0 M40 0 L40 15" stroke="currentColor" strokeWidth="3" fill="none"/>
            <path d="M0 40 L15 40 M0 40 L0 25" stroke="currentColor" strokeWidth="3" fill="none"/>
            <path d="M40 40 L25 40 M40 40 L40 25" stroke="currentColor" strokeWidth="3" fill="none"/>
        ...
        <div className="absolute bottom-32 left-16 opacity-8">
          <svg width="60" height="50" viewBox="0 0 60 50" className="text-white/15">
            <rect x="5" y="15" width="50" height="30" rx="5" fill="none" stroke="currentColor" strokeWidth="2"/>
            <rect x="20" y="5" width="20" height="10" rx="2" fill="currentColor"/>
        ...
        <div className="absolute top-1/4 left-1/4 opacity-10">
          <svg width="100" height="100" viewBox="0 0 100 100" className="text-red-500/20">
            <g transform="translate(50,50)">
              {/* Slide shape */}
              <path d="M-30 -20 Q-10 -30 10 -20 L30 20 Q10 30 -10 20 Z" fill="currentColor" opacity="0.6"/>
              {/* Climbing frame */}
        ...
        <div className="absolute top-1/2 right-10 opacity-5 transform -translate-y-1/2">
          <svg width="30" height="200" viewBox="0 0 30 200" className="text-white/20">
            {[...Array(8)].map((_, i) => (
              <circle key={i} cx="15" cy={15 + i * 24} r="8" fill="currentColor" opacity="0.3"/>
            ))}
            <path d="M15 0 Q5 50 15 100 T15 200" stroke="currentColor" strokeWidth="2" fill="none" opacity="0.5"/>
          </svg>
        </div>
        ...
        {/* Family Fun Icons */}
        <div className="absolute top-1/3 left-1/3 opacity-5 text-white text-3xl">🎈</div>
        <div className="absolute bottom-1/4 right-1/4 opacity-5 text-red-500 text-2xl">🎉</div>
        <div className="absolute top-2/3 left-1/6 opacity-5 text-white text-xl">📸</div>
        <div className="absolute top-1/6 right-1/3 opacity-5 text-red-500 text-2xl">🤸</div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 text-xl leading-relaxed max-w-4xl mx-auto">
            Take a virtual tour of our amazing family entertainment facility and see why
            FNF Arena is the perfect destination for kids and families in Hyderabad.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-br from-red-500/10 to-transparent p-6 rounded-xl border border-red-500/20">
            ...
            <h4 className="text-white font-bold text-lg mb-2">Softplay Zone</h4>
            <p className="text-gray-300 text-sm">
              Safe, colorful play area with slides, climbing frames, and ball pits designed for toddlers and young children.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-red-500/10 to-transparent p-6 rounded-xl border border-red-500/20">
            ...
            <h4 className="text-white font-bold text-lg mb-2">Trampoline Park</h4>
            <p className="text-gray-300 text-sm">
              High-energy bouncing fun with safety nets and foam pits for kids and adults to enjoy together.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-red-500/10 to-transparent p-6 rounded-xl border border-red-500/20">
            ...
            <h4 className="text-white font-bold text-lg mb-2">Bull Ride Challenge</h4>
            <p className="text-gray-300 text-sm">
              Test your balance and courage on our mechanical bull with adjustable difficulty levels and safety mats.
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-br from-red-500/20 via-amber-500/20 to-orange-500/20 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-red-500/30">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h3 className="text-4xl font-bold font-sansitaOne text-white">Experience Family Fun Live!</h3>
              <Zap className="w-8 h-8 text-red-400" />
            </div>
            <p className="text-gray-200 mb-8 max-w-2xl mx-auto text-lg">
              Ready to create your own family memories? Book your session today and become part of our fun gallery.
            </p>

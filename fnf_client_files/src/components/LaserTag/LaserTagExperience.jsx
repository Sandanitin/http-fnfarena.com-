...
import { Play, Pause, Star, Quote, ArrowRight, Users, Trophy, Clock, Volume2, VolumeX, ExternalLink } from "lucide-react";
...
export default function LaserTagExperience({
  ...
  useEffect(() => {
    // console.log('LaserTagExperience received videos:', videos);
  }, [videos]);
    ...
    return [
      {
        ...
        image: "https://cdn.acsdev.in/FNF/6995f8bdb6611.png",
        text: "The laser tag arena at FNF is incredible! The technology is top-notch and the gameplay is so immersive. Best laser tag experience I've ever had!",
        rating: 5
      },
      {
        name: "Sneha Patel",
        role: "Team Building Coordinator",
        image: "https://cdn.acsdev.in/FNF/69cfccead4bc6.jpg",
        text: "We organized our company team building event here. The staff was amazing and the team deathmatch mode was perfect for building teamwork!",
        rating: 5
      },
      {
        name: "Rohit Kumar",
        role: "Birthday Party Host",
        image: "https://cdn.acsdev.in/FNF/69cfccec43789.jpg",
        text: "My son's birthday party was a huge hit! All the kids loved the laser tag arena. The equipment is safe and the games are so much fun.",
        rating: 5
      }
    ];
  }, [reviews]);
  ...
  const experienceVideo = React.useMemo(() => {
    ...
    if (videos && videos.length > 0) {
      ...
      if (selectedVideo) {
        ...
        return {
          ...
          label: selectedVideo.label || ["Laser Tag Experience"],
          type: selectedVideo.type || 'direct',
          videoId: selectedVideo.videoId,
          poster: "https://cdn.acsdev.in/FNF/6995f8bdb6611.png"
        };
      }
    }
    ...
    return {
      url: "https://cdn.acsdev.in/FNF/6995f8bdb6611.png",
      label: ["Laser Tag Experience"],
      type: 'image',
      poster: "https://cdn.acsdev.in/FNF/6995f8bdb6611.png"
    };
  }, [videos]);
  ...
  const metricsData = React.useMemo(() => {
    const fallbackMetrics = [
      { value: "15000", label: "Battles Fought", color: "red" },
      { value: "8000", label: "Combat Veterans", color: "amber" },
      { value: "750", label: "Events Hosted", color: "orange" },
      { value: "100%", label: "Adrenaline Rush", color: "red" }
    ];
  ...
  const countersData = React.useMemo(() => {
    ...
    if (metrics) {
      return {
        battles: parseInt(metrics.total_battles) || parseInt(metrics.repeat_customers) || fallbackCounters.battles,
        players: parseInt(metrics.total_customers) || parseInt(metrics.revenue_growth) || fallbackCounters.players,
        events: parseInt(metrics.total_events) || parseInt(metrics.safety_score) || fallbackCounters.events
      };
    }
  ...
  return (
    ...
    >
      <div className="absolute left-0 right-0 top-2 h-6 z-10" aria-hidden="true"
        style={{
          backgroundImage: `
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 right-0 w-1/2 h-full">
          <img
            src="https://cdn.acsdev.in/FNF/6995f8bdb6611.png"
        ...
        <div className="absolute inset-0 opacity-5">
          <svg width="100%" height="100%" viewBox="0 0 1200 800" className="text-white/20">
            <defs>
              <pattern id="laserPattern" x="0" y="0" width="100" height="20" patternUnits="userSpaceOnUse">
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <span className="text-red-500 text-sm font-semibold">Ultimate Combat</span>
              </motion.div>

              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 font-sansitaOne leading-tight">
                Where Every
                <span className="block text-red-500">Shot Matters</span>
              </h2>

              <p className="text-gray-300 text-lg leading-relaxed max-w-lg">
                Step into our high-tech laser tag arena where precision meets excitement.
                Experience tactical combat with cutting-edge equipment and immersive gameplay.
              </p>
            </div>
            ...
            >
              <button
                onClick={() => {
                  if (experienceVideo.type === 'youtube') {
                    ...
                    scrollToSection('LaserTagGallery');
                  }
                }}
              ...
              >
                ...
                {experienceVideo.type === 'youtube' ? 'Watch YouTube Video' : 'Watch Combat Video'}
                    ...
                    {videoState.showPoster && (
                      <div className="absolute inset-0 z-20">
                        <img
                          ...
                          alt="Laser tag combat video preview"
                          className="w-full h-full object-cover"
                          onError={(e) => {
                            e.target.src = "https://cdn.acsdev.in/FNF/6995f8bdb6611.png";
                          }}
                        />
                        <div className="absolute inset-0 bg-black/40" />
                      </div>

...
export default function LaserTagGallery({ galleryImages, videos, metrics }) {
  ...
  const fallbackImages = [
    ...
    {
      src: "https://cdn.acsdev.in/FNF/6995f8bdb6611.png",
      alt: "Team battle in progress with laser guns",
      title: "Team Battles",
      category: "Combat",
      likes: 234,
      type: "image"
    ...
    {
      src: "https://cdn.acsdev.in/FNF/69cfccead4bc6.jpg",
      alt: "High-tech laser tag equipment and vests",
    ...
    {
      src: "https://cdn.acsdev.in/FNF/69cfccec43789.jpg",
      alt: "Strategic cover points and arena design",
    ...
    {
      src: "https://cdn.acsdev.in/FNF/6995f8bdb6611.png",
      alt: "Birthday party laser tag celebration",
      title: "Celebrations",
      category: "Events",
      likes: 312,
      type: "image"
    ...
    {
      src: "https://cdn.acsdev.in/FNF/69cfccead4bc6.jpg",
      alt: "Tournament play with live scoreboard",
      title: "Tournaments",
  ...
  const categories = ["Arena", "Combat", "Equipment", "Strategy", "Events", "Competition"];
  const titles = [
    "Combat Arena",
    "Team Battles",
    "Premium Equipment",
  ...
  const metricsData = React.useMemo(() => {
    const fallbackMetrics = [
      { value: "2-16", label: "Players per Game", color: "red" },
      { value: "15min", label: "Battle Duration", color: "amber" },
      { value: "360°", label: "Detection Range", color: "orange" },
    ...
    metricsMapping.forEach((mapping, index) => {
      const value = laserTagMetrics[mapping.field];
      const suffix = laserTagMetrics[mapping.suffix] || '';
  ...
  return (
    <section id="LaserTagGallery" className="relative bg-[#1e2125] text-white py-16 px-4 sm:px-6 md:px-10 lg:px-20 overflow-hidden">

      {/* Enhanced Laser Tag Gallery Background */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Combat Grid Pattern */}
        <div className="absolute inset-0 opacity-5">
          <svg width="100%" height="100%" viewBox="0 0 1200 800" className="text-red-400/20">
            <defs>
              <pattern id="laserTagGrid" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#laserTagGrid)"/>
          </svg>
        </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 text-xl leading-relaxed max-w-4xl mx-auto">
            Explore our collection of thrilling laser tag battles, from tactical team combat to solo deathmatch,
        ...
        >
          <div className="bg-gradient-to-br from-red-500/20 via-amber-500/20 to-orange-500/20 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-red-500/30">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h3 className="text-4xl font-bold font-sansitaOne text-white">Experience Combat Live!</h3>

...
export default function SkyCycleHero({
  activity,
  media,
  mainImage,
  landingImage,
  ...
  const heroBackground = landingImage || "https://cdn.acsdev.in/FNF/699b3fa7db259.jpg";
  const floatingImages = galleryImages && galleryImages.length > 0
    ? galleryImages.slice(0, 4)
    : [
        "https://cdn.acsdev.in/FNF/699b3fa7db259.jpg",
        "https://cdn.acsdev.in/FNF/69d3763841f0b.jpg",
        "https://cdn.acsdev.in/FNF/69d3763709bc8.jpg",
        "https://cdn.acsdev.in/FNF/699b3fa7db259.jpg"
      ];
  ...
  return (
    <section className="relative w-full h-[50vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroBackground}
          alt="Sky cycle adventure background"
          loading="lazy"
          className="w-full h-full object-cover blur-sm"
        />
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900/80 via-red-900/60 to-red-800/80" />

        {/* Sky Cycle Track Lines Background */}
        ...
        <div className="absolute inset-0 pointer-events-none opacity-8 hidden sm:block">
          ...
          <div className="absolute bottom-20 left-20 text-red-300 text-5xl transform rotate-45">💨</div>
          <div className="absolute top-20 right-96 text-white text-3xl transform -rotate-12">🌤️</div>
      ...
      <div className="absolute inset-0 pointer-events-none z-[18] hidden sm:block">
        ...
        <div className="absolute inset-0 opacity-15">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Deep background sky cycle image"
              loading="lazy"
        ...
        <div className="absolute inset-0 opacity-25">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Background depth sky cycle image"
              loading="lazy"
              className="w-full h-full rounded object-cover"
            />
          </div>
        ...
        <div className="absolute inset-0 opacity-40">
          ...
          >
            <img
              src={paddedImages[1]}
              alt="Mid-depth floating sky cycle image"
              loading="lazy"
              className="w-full h-full rounded object-cover"
            />
          </div>
        ...
        <div className="absolute inset-0 opacity-65">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Mid-foreground floating sky cycle image"
              loading="lazy"
        ...
        <div className="absolute inset-0">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Foreground floating sky cycle image"
              loading="lazy"
              className="w-full h-full rounded-lg object-cover"
            />
          </div>
      ...
      {/* ROTATED TEXT */}
      <div
        className="hidden lg:block absolute right-[-70px] top-[89px] pointer-events-none z-[15]"
        style={{
        ...
        <div className="w-full lg:w-1/2">
          <h1 className="text-[60px] font-bold drop-shadow-lg font-josefin leading-tight font-sansitaOne">
            <span className="text-red-400 block">
              {activity?.name || 'Sky Cycle'}
            </span>
            <span className="text-white block">Sky High Adventure</span>
          </h1>
        </div>
      </div>

...
export default function BowlingExperience({
  ...
  useEffect(() => {
    // console.log('BowlingExperience received videos:', videos);
  }, [videos]);
    ...
    return [
      {
        ...
        image: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
        text: "FNF Arena made our company bowling tournament absolutely fantastic! The staff was professional and the lanes were perfect.",
        rating: 5
      },
      {
        name: "Priya Sharma",
        ...
        image: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
        text: "My daughter's 12th birthday party was a huge success here. The kids had a blast and the service was exceptional!",
        rating: 5
      },
      {
        name: "Amit Patel",
        role: "Regular Player",
        image: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
        text: "I've been coming here for months. The equipment is top-notch and the atmosphere is always energetic and fun.",
        rating: 5
      }
    ];
  }, [reviews]);
  ...
  const experienceVideo = React.useMemo(() => {
    ...
    if (videos && videos.length > 0) {
      ...
      if (selectedVideo) {
        ...
        return {
          ...
          label: selectedVideo.label || ["Bowling Experience"],
          type: selectedVideo.type || 'direct',
          videoId: selectedVideo.videoId,
          poster: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg"
        };
      }
    }
    ...
    return {
      url: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
      label: ["Bowling Experience"],
      type: 'image',
      poster: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg"
    };
  }, [videos]);
  ...
  const metricsData = React.useMemo(() => {
    const fallbackMetrics = [
      { value: "10000", label: "Strikes Bowled", color: "red" },
      { value: "5000", label: "Happy Players", color: "amber" },
      { value: "500", label: "Events Hosted", color: "orange" },
  ...
  const countersData = React.useMemo(() => {
    ...
    if (metrics) {
      return {
        strikes: parseInt(metrics.total_strikes) || parseInt(metrics.repeat_customers) || fallbackCounters.strikes,
  ...
  useEffect(() => {
    const animateCounters = () => {
      ...
      const timer = setInterval(() => {
        ...
        setCounters({
          strikes: Math.floor(targets.strikes * progress),
    ...
    const element = document.getElementById('bowling-experience');
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 right-0 w-1/2 h-full">
          <img
            src="https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg"
            alt="Bowling experience background"
            loading="lazy"
        ...
        {/* Bowling Alley Perspective Lines */}
        <div className="absolute inset-0 opacity-5">
          <svg width="100%" height="100%" viewBox="0 0 1200 800" className="text-white/20">
            <defs>
              <pattern id="lanePattern" x="0" y="0" width="100" height="20" patternUnits="userSpaceOnUse">
                <line x1="0" y1="10" x2="100" y2="10" stroke="currentColor" strokeWidth="1"/>
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#lanePattern)"/>
            {/* Perspective lines */}
        ...
        <div className="absolute top-1/4 left-1/4 opacity-10">
          <svg width="200" height="200" viewBox="0 0 200 200" className="text-red-500/30">
            <g transform="translate(100,100)">
              ...
              <text x="0" y="5" textAnchor="middle" className="text-xs font-bold fill-white">X</text>
            </g>
          </svg>
        </div>
          ...
          >
            ...
            <div>
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 font-sansitaOne leading-tight">
                Where Every
                <span className="block text-red-500">Strike Counts</span>
              </h2>

              <p className="text-gray-300 text-lg leading-relaxed max-w-lg">
                Immerse yourself in the ultimate bowling experience with cutting-edge technology,
                premium amenities, and an atmosphere that transforms every game into an unforgettable moment.
              </p>
            </div>
            ...
            >
              <button
                onClick={() => {
                  if (experienceVideo.type === 'youtube') {
                    ...
                    scrollToSection('bowlingGallery');
                  }
                }}
              ...
              >
                ...
                {experienceVideo.type === 'youtube' ? 'Watch YouTube Video' : 'Watch Experience Video'}
                    ...
                    {videoState.showPoster && (
                      <div className="absolute inset-0 z-20">
                        <img
                          ...
                          alt="Bowling experience video preview"
                          className="w-full h-full object-cover"
                          onError={(e) => {
                            e.target.src = "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg";
                          }}
                        />
                        <div className="absolute inset-0 bg-black/40" />
                      </div>

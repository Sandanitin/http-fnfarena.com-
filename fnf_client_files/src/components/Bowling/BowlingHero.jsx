...
const bowlingHeroImages = {
  main: {
    heroBackground: heroBg,
    bowlingHero: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
    bowlingAction: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg"
  },
  floating: {
    bowling1: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
    bowling2: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
    bowling3: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
    bowling4: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg"
  }
};
...
export default function BowlingHero({
  ...
  const heroBackground = landingImage || bowlingHeroImages.main.heroBackground;

  const heroTitle = activity?.name || "Bowling";
  const heroDescription = activity?.description || "Strike & Spare";

  // Use API gallery images or fallback to default images
  const floatingImages = galleryImages && galleryImages.length > 0
    ? galleryImages.slice(0, 4)
    : Object.values(bowlingHeroImages.floating);

  // Ensure we have at least 4 images for the floating effect
  const paddedImages = [...floatingImages];
  while (paddedImages.length < 4) {
    paddedImages.push(paddedImages[0] || mainImage || Object.values(bowlingHeroImages.floating)[0]);
  }
    ...
    <section className="relative w-full h-[50vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          ...
          onError={(e) => {
            e.target.src = bowlingHeroImages.main.heroBackground;
          }}
        />

        <div className="absolute inset-0 bg-black/80" />

        {/* Bowling Lane Lines Background */}
        ...
        <div className="absolute inset-0 pointer-events-none opacity-5 hidden sm:block">
          ...
          <div className="absolute top-32 left-32 text-white text-4xl transform -rotate-6">🎳</div>
          <div className="absolute bottom-20 left-20 text-white text-5xl transform rotate-45">🎳</div>
          <div className="absolute top-20 right-96 text-white text-3xl transform -rotate-12">🎳</div>
          <div className="absolute bottom-32 right-80 text-white text-4xl transform rotate-30">🎳</div>
        </div>
        ...
        <div className="absolute top-1/4 left-1/4 opacity-8">
          <svg width="200" height="200" viewBox="0 0 200 200" className="text-red-500/20">
            ...
            <text x="100" y="100" textAnchor="middle" className="text-xl font-bold fill-current">STRIKE</text>
          </svg>
        </div>
      </div>
        ...
        <div className="w-full h-full scale-[0.85] sm:scale-[0.9] lg:scale-[0.95] origin-top-right">
          ...
          <div className="absolute inset-0 opacity-15">
            ...
            >
              <img
                src={paddedImages[0]}
                alt="Deep background bowling image"
                loading="lazy"
                className="w-full h-full rounded object-cover"
                onError={(e) => {
                  e.target.src = bowlingHeroImages.floating.bowling1;
                }}
              />
            </div>
            ...
            >
              <img
                ...
                className="w-full h-full rounded object-cover"
                onError={(e) => {
                  e.target.src = bowlingHeroImages.floating.bowling2;
                }}
              />
            </div>
            ...
            >
              <img
                ...
                className="w-full h-full rounded object-cover"
                onError={(e) => {
                  e.target.src = bowlingHeroImages.floating.bowling3;
                }}
              />
            </div>
            ...
            >
              <img
                ...
                className="w-full h-full rounded object-cover"
                onError={(e) => {
                  e.target.src = bowlingHeroImages.floating.bowling4;
                }}
              />
            </div>
          </div>
          ...
          <div className="absolute inset-0 opacity-25 scale-[0.85] origin-right">
            ...
            >
              <img
                src={paddedImages[0]}
                alt="Background depth bowling image"
                loading="lazy"
                className="w-full h-full rounded object-cover"
                onError={(e) => {
                  e.target.src = bowlingHeroImages.floating.bowling1;
          ...
          <div className="absolute inset-0 opacity-40">
            ...
            >
              <img
                src={paddedImages[1]}
                alt="Mid-depth floating bowling image"
                loading="lazy"
                className="w-full h-full rounded object-cover"
                onError={(e) => {
                  e.target.src = bowlingHeroImages.floating.bowling2;
          ...
          <div className="absolute inset-0 opacity-65">
            ...
            >
              <img
                src={paddedImages[0]}
                alt="Mid-foreground floating bowling image"
                loading="lazy"
          ...
          <div className="absolute inset-0">
            ...
            >
              <img
                src={paddedImages[0]}
                alt="Foreground floating bowling image"
                loading="lazy"
                className="w-full h-full rounded-lg object-cover"
                onError={(e) => {
                  e.target.src = bowlingHeroImages.floating.bowling1;
      ...
      {/* ROTATED TEXT */}
      <div
        className="hidden lg:block absolute right-[-120px] top-[180px] pointer-events-none z-[15]"
        style={{

...
export default function BowlingGallery({ galleryImages, videos, metrics }) {
  ...
  const fallbackImages = [
    ...
    {
      src: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
      alt: "Group of friends enjoying bowling",
      title: "Group Fun",
      category: "Groups",
      likes: 234,
      type: "image"
    ...
    {
      src: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
      alt: "Modern bowling equipment and shoes",
    ...
    {
      src: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
      alt: "Comfortable seating area with snack bar",
      title: "Comfort Zone",
      category: "Facility",
      likes: 267,
      type: "image"
    ...
    {
      src: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
      alt: "Birthday party celebration at bowling lanes",
      title: "Celebrations",
      category: "Events",
      likes: 312,
      type: "image"
    ...
    {
      src: "https://cdn.acsdev.in/FNF/69ce4ac2edac3.jpg",
      alt: "Tournament play with scoreboard",
      title: "Tournaments",
  ...
  const categories = ["Lanes", "Groups", "Equipment", "Facility", "Events", "Competition"];
  const titles = [
    "Professional Lanes",
    "Group Fun",
    "Premium Equipment",
  ...
  const processedVideos = React.useMemo(() => {
    if (videos && videos.length > 0) {
      return videos.map((video, index) => {
        const baseVideo = {
          alt: `Bowling video ${index + 1}`,
          title: video.label && video.label[0] ? video.label[0] : `Bowling Video ${index + 1}`,
          category: categories[index % categories.length],
          likes: Math.floor(Math.random() * 200) + 150,
  ...
  const metricsData = React.useMemo(() => {
    const fallbackMetrics = [
      { value: "8", label: "Professional Lanes", color: "red" },
      { value: "50+", label: "Daily Players", color: "amber" },
    ...
    metricsMapping.forEach((mapping, index) => {
      const value = bowlingMetrics[mapping.field];
      const suffix = bowlingMetrics[mapping.suffix] || '';
  ...
  return (
    <section id="bowlingGallery" className="relative bg-[#1e2125] text-white py-16 px-4 sm:px-6 md:px-10 lg:px-20 overflow-hidden">

      {/* Enhanced Bowling Gallery Background */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Racing Track Grid Pattern */}
        <div className="absolute inset-0 opacity-5">
          <svg width="100%" height="100%" viewBox="0 0 1200 800" className="text-red-400/20">
            <defs>
              <pattern id="bowlingGrid" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#bowlingGrid)"/>
          </svg>
        </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 text-xl leading-relaxed max-w-4xl mx-auto">
            Explore our collection of thrilling bowling moments, from strikes and spares to family fun,
            captured at FNF Arena's premier bowling facility.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-br from-red-500/20 via-amber-500/20 to-orange-500/20 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-red-500/30">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h3 className="text-4xl font-bold font-sansitaOne text-white">Experience Bowling Live!</h3>
              <Zap className="w-8 h-8 text-red-400" />
            </div>
            <p className="text-gray-200 mb-8 max-w-2xl mx-auto text-lg">
              Ready to create your own bowling memories? Book your session today and become part of our bowling gallery.
            </p>

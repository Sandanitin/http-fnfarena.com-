...
export default function BowlingRules({ protocols }) {
  // Get Bowling protocols data
  const bowlingProtocols = protocols && protocols.length > 0 ? protocols[0] : null;
  ...
  const ruleCategories = React.useMemo(() => {
      ...
      return {
        entry: {
          ...
          items: [
            ...
            "Only players are allowed in the bowling zone",
        ...
        footwear: {
          ...
          items: [
            "Bowling shoes are mandatory",
            "No slippers, sandals, or heels; go barefoot if needed",
            "No running, jumping, or sliding on lanes",
            "Do not cross the foul line — lanes are slippery"
          ]
        },
        etiquette: {
          ...
          items: [
            "Wait for your turn; let the previous player finish",
            "Use one ball at a time on each lane",
            "Stay on your own lane; don't enter others' areas",
        ...
        prohibited: {
          ...
          items: [
            "No food or drinks in the bowling zone",
            "Smoking and vaping are prohibited",
            "Return shoes and balls to racks after use",
    ...
    return {
      entry: {
        icon: <Shield className="w-6 h-6" />,
        title: "Entry Requirements",
        items: bowlingProtocols.requirements ? bowlingProtocols.requirements.map(req => req) : [
          "Entry allowed only with a valid game token",
          "Only players are allowed in the bowling zone",
          "Spectators must stay outside",
          "Kids under 12 must have adult supervision"
      ...
      footwear: {
        icon: <Users className="w-6 h-6" />,
        title: "Footwear & Safety",
        items: bowlingProtocols.equipment ? bowlingProtocols.equipment.map(eq => eq) : [
          "Bowling shoes are mandatory",
          "No slippers, sandals, or heels; go barefoot if needed",
          "No running, jumping, or sliding on lanes",
          "Do not cross the foul line — lanes are slippery"
      ...
      etiquette: {
        icon: <Clock className="w-6 h-6" />,
        title: "Game Etiquette",
        items: bowlingProtocols.etiquette ? bowlingProtocols.etiquette.map(et => et) : [
          "Wait for your turn; let the previous player finish",
          "Use one ball at a time on each lane",
          "Stay on your own lane; don't enter others' areas",
          "Respect staff, players, and property"
      ...
      prohibited: {
        icon: <Ban className="w-6 h-6" />,
        title: "Prohibited Items",
        items: bowlingProtocols.rules ? bowlingProtocols.rules.map(rule => rule) : [
          "No food or drinks in the bowling zone",
          "Smoking and vaping are prohibited",
          "Return shoes and balls to racks after use",
          "Follow staff instructions at all times"
  ...
  return (
    <section className="relative bg-[#1e2125] text-white py-16 px-4 sm:px-6 md:px-10 lg:px-20 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Bowling Shoes Pattern */}
        <div className="absolute bottom-20 right-20 opacity-8">
          <svg width="80" height="40" viewBox="0 0 80 40" className="text-white/10">
            <ellipse cx="20" cy="30" rx="18" ry="8" fill="currentColor"/>
            <ellipse cx="60" cy="30" rx="18" ry="8" fill="currentColor"/>
            <rect x="10" y="15" width="16" height="15" rx="2" fill="currentColor"/>
            <rect x="50" y="15" width="16" height="15" rx="2" fill="currentColor"/>
          </svg>
        </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-white mt-4 text-sm md:text-base leading-relaxed max-w-3xl mx-auto">
            ...
            bowling experience for everyone at FNF Arena.
          </p>
        </motion.div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                environment for all players. Thank you for your cooperation.
              </p>
            </div>
          </div>
        </motion.div>

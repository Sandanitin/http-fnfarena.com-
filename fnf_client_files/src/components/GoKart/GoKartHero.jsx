...
export default function GoKartHero({
  ...
  const heroBackground = landingImage || heroBg;
  const floatingImages = galleryImages && galleryImages.length > 0
    ? galleryImages.slice(0, 4)
    : [
        "https://cdn.acsdev.in/FNF/69e9ee576a97b.jpg",
        "https://cdn.acsdev.in/FNF/69e9ee5815536.jpg",
        "https://cdn.acsdev.in/FNF/69e9ee59a10de.jpg",
        "https://cdn.acsdev.in/FNF/69e9ee576a97b.jpg"
      ];
  ...
  return (
    <section className="relative w-full h-[50vh] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-[18] hidden sm:block">
        ...
        <div className="absolute inset-0 opacity-15">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Deep background go-kart image"
              loading="lazy"
        ...
        <div className="absolute inset-0 opacity-25">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Background depth go-kart image"
              loading="lazy"
              className="w-full h-full rounded object-cover"
            />
          </div>
        ...
        <div className="absolute inset-0 opacity-40">
          ...
          >
            <img
              src={paddedImages[1]}
              alt="Mid-depth floating go-kart image"
              loading="lazy"
              className="w-full h-full rounded object-cover"
            />
          </div>
        ...
        <div className="absolute inset-0 opacity-65">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Mid-foreground floating go-kart image"
              loading="lazy"
        ...
        <div className="absolute inset-0">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Foreground floating go-kart image"
              loading="lazy"
              className="w-full h-full rounded-lg object-cover"
            />
          </div>
      ...
      {/* ROTATED TEXT */}
      <div
        className="hidden lg:block absolute right-[-120px] top-[125px] pointer-events-none z-[15]"
        style={{
        ...
        <div className="w-full lg:w-1/2">
          <h1 className="text-[60px] font-bold drop-shadow-lg font-josefin leading-tight font-sansitaOne">
            <span className="text-red-500 block">
              {activity?.name || 'Go Kart Racing'}
            </span>
            <span className="text-white block">Fun Turns Furious</span>
          </h1>
        </div>
      </div>

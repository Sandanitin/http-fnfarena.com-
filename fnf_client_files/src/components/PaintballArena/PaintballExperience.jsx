...
import { Play, Pause, Star, Quote, ArrowRight, Users, Trophy, Clock, Zap, Target, Award, Shield, Crosshair, Volume2, VolumeX, ExternalLink } from "lucide-react";
import {IMGUrl } from '../../config/apiconfig';
export default function PaintballExperience({
  reviews = [],
  loading,
  error,
  averageRating,
  ...
  useEffect(() => {
    // console.log('PaintballExperience received videos:', videos);
  }, [videos]);
    ...
    return [
      {
        name: "Alex Johnson",
        role: "Combat Warrior",
        text: "The tactical paintball experience was absolutely incredible! The equipment and battlefield design is unmatched.",
        rating: 5,
      ...
      },
      {
        name: "Sarah Chen",
        role: "Team Leader",
        text: "Perfect for team building! Our corporate group had an amazing time with the strategic gameplay.",
        rating: 5,
      ...
      },
      {
        name: "Mike Rodriguez",
        role: "Combat Veteran",
        text: "Outstanding battlefield design and professional safety equipment. This is real tactical combat!",
        rating: 5,
  ...
  const experienceVideo = React.useMemo(() => {
    ...
    if (videos && videos.length > 0) {
      ...
      if (selectedVideo) {
        ...
        return {
          ...
          label: selectedVideo.label || ["Paintball Combat Experience"],
          type: selectedVideo.type || 'direct',
          videoId: selectedVideo.videoId,
          poster: "https://cdn.acsdev.in/FNF/698c91d4c1666.jpg"
        };
      }
    }
    ...
    return {
      url: "https://cdn.acsdev.in/FNF/698c91d4c1666.jpg",
      label: ["Paintball Combat Experience"],
      type: 'image',
      poster: "https://cdn.acsdev.in/FNF/698c91d4c1666.jpg"
    };
  }, [videos]);
  ...
  const metricsData = React.useMemo(() => {
    ...
    if (metrics) {
      return {
        battles: parseInt(metrics.repeat_customers) || fallbackMetrics.battles,
        players: parseInt(metrics.revenue_growth) || fallbackMetrics.players,
  ...
  useEffect(() => {
    ...
    const element = document.getElementById('paintball-experience');
          ...
          <div className="h-full w-full" style={{
            backgroundImage: `
              repeating-linear-gradient(
                ...
                rgba(34, 197, 94, 0.3) 40px
              )
            `
          }} />
        </div>

        {/* Circular Target Elements */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-red-500/20 to-red-400/20 border border-red-500/30 rounded-full px-6 py-3">
                ...
                <span className="text-red-400 text-base font-bold">Ultimate Combat Experience</span>
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                {/* Title */}
                <div>
                  <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white font-sansitaOne leading-tight">
                    Paintball
                ...
                <div className="lg:pt-4">
                  <p className="text-gray-300 text-xl leading-relaxed">
                    Experience the ultimate adrenaline rush with our professional paintball arena featuring tactical battlefields and premium equipment for maximum combat excitement.
                  </p>
                </div>
              </div>
            </motion.div>
              ...
              <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl">
                {experienceVideo.type === 'youtube' ? (
                    ...
                    {videoState.showPoster && (
                      <div className="absolute inset-0 z-20">
                        <img
                          ...
                          alt="Paintball combat video preview"
                          className="w-full h-full object-cover"
                          onError={(e) => {
                            e.target.src = "https://cdn.acsdev.in/FNF/698c91d4c1666.jpg";
                          }}
                        />
                        <div className="absolute inset-0 bg-black/40" />
                      </div>
                  ...
                  <>
                    <img
                      src={experienceVideo.url}
                      alt="Paintball arena video preview"
                      loading="lazy"
                      className="w-full h-full object-cover"
                      onError={(e) => {
                        e.target.src = "https://cdn.acsdev.in/FNF/698c91d4c1666.jpg";
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      onClick={() => scrollToSection('PaintballGallery')}
                    >
                      <div className="w-24 h-24 bg-gradient-to-r from-red-500 to-red-600 rounded-full flex items-center justify-center text-white shadow-2xl">
                        <Play className="w-10 h-10 ml-2" />
                      </div>
                ...
                <div className="absolute bottom-6 left-6 right-6 z-40">
                  ...
                  <p className="text-gray-200 text-sm">
                    {experienceVideo.label && experienceVideo.label[0] ? experienceVideo.label[0] : 'Watch our warriors in action'}
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <button
              onClick={() => {
                if (experienceVideo.type === 'youtube') {
                  ...
                  scrollToSection('PaintballGallery');
                }
              }}

...
// Image object for paintball arena
const paintballHeroImages = {
  main: {
    heroBackground: heroBg,
    paintballHero: "https://cdn.acsdev.in/FNF/69d3f348dbfef.jpg",
    combatArena: "https://cdn.acsdev.in/FNF/69d3f3481df1a.jpg"
  },
  floating: {
    gear1: "https://cdn.acsdev.in/FNF/698c91d4c1666.jpg",
    gear2: "https://cdn.acsdev.in/FNF/69d3f3481df1a.jpg",
    gear3: "https://cdn.acsdev.in/FNF/698c91d4c1666.jpg",
    gear4: "https://cdn.acsdev.in/FNF/69d3f3481df1a.jpg"
  }
};

export default function PaintballHero({
  activity,
  media,
  mainImage,
  landingImage,
  ...
  const heroBackground = landingImage || paintballHeroImages.main.heroBackground;
  const floatingImages = galleryImages && galleryImages.length > 0
    ? galleryImages.slice(0, 4)
    : [
        paintballHeroImages.floating.gear1,
        paintballHeroImages.floating.gear2,
        paintballHeroImages.floating.gear3,
        paintballHeroImages.floating.gear4
      ];

  // Ensure we have at least 4 images for the floating effect
  const paddedImages = [...floatingImages];
  while (paddedImages.length < 4) {
    paddedImages.push(paddedImages[0] || mainImage || paintballHeroImages.floating.gear1);
  }
      ...
      <div className="absolute inset-0 pointer-events-none z-[18] hidden sm:block">
        ...
        <div className="absolute inset-0 opacity-15">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Deep background paintball gear image"
              loading="lazy"
        ...
        <div className="absolute inset-0 opacity-25">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Background depth paintball gear image"
              loading="lazy"
              className="w-full h-full rounded object-cover"
            />
          </div>
        ...
        <div className="absolute inset-0 opacity-40">
          ...
          >
            <img
              src={paddedImages[1]}
              alt="Mid-depth floating paintball gear image"
              loading="lazy"
              className="w-full h-full rounded object-cover"
            />
          </div>
        ...
        <div className="absolute inset-0 opacity-65">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Mid-foreground floating paintball gear image"
              loading="lazy"
        ...
        <div className="absolute inset-0">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Foreground floating paintball gear image"
              loading="lazy"
              className="w-full h-full rounded-lg object-cover"
            />
          </div>
        ...
        <div className="w-full lg:w-1/2">
          <h1 className="text-[60px] font-bold drop-shadow-lg font-josefin leading-tight font-sansitaOne">
            <span className="text-red-500 block">
              {activity?.name || 'Combat & Strategy'}
            </span>
            <span className="text-white block">Paint. Aim. Dominate</span>
          </h1>
        </div>
      </div>

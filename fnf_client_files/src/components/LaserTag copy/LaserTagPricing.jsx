...
import { Target, Users, Clock, ArrowRight, Check, Zap, Crown, Gift, Shield, Trophy } from "lucide-react";
  ...
  const packages = [
    {
      ...
      price: 299,
      originalPrice: 399,
      duration: "Per Person (15 mins)",
      features: [
        "15 Minutes Combat Session",
    ...
    },
    {
      ...
      price: 499,
      originalPrice: 699,
      duration: "Per Person (30 mins)",
      features: [
        "30 Minutes Combat Session",
        "Premium Laser Tag Equipment",
        "Multiple Game Modes",
    ...
    },
    {
      ...
      price: 799,
      originalPrice: 999,
      duration: "Per Person (45 mins)",
      features: [
        "45 Minutes Extended Combat",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 text-xl leading-relaxed max-w-4xl mx-auto">
            Select the perfect laser tag package for your combat level. From quick battles to extended warfare,
            we have options for every warrior and group size.
          </p>
        </motion.div>
                ...
                <div className="mt-auto space-y-4">
                  ...
                  <div className="pt-4 border-t border-white/20 text-center">
                    <p className="text-xs text-gray-400">
                      * Group discounts available - Equipment included
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-200">
            <div className="space-y-3">
              <p className="text-sm leading-relaxed">
                <strong className="text-red-400">Age Requirement:</strong> Minimum age 8 years for all combat sessions
              </p>
              <p className="text-sm leading-relaxed">
                <strong className="text-red-400">Safety First:</strong> All players must attend safety briefing
              </p>
              <p className="text-sm leading-relaxed">
                <strong className="text-red-400">Equipment:</strong> Professional laser tag gear included in all packages
              </p>
            </div>
            <div className="space-y-3">
              <p className="text-sm leading-relaxed">
                <strong className="text-red-400">Group Bookings:</strong> Special rates for groups of 10+ players
              </p>
              <p className="text-sm leading-relaxed">
                <strong className="text-red-400">Arena Rules:</strong> Follow all safety protocols during combat
              </p>
              <p className="text-sm leading-relaxed">
                <strong className="text-red-400">Booking:</strong> Advance booking recommended for guaranteed slots
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="text-center bg-gradient-to-br from-red-500/20 to-transparent backdrop-blur-sm rounded-2xl p-6 border border-red-500/30">
            ...
            <p className="text-gray-400 text-sm">Professional equipment and trained staff</p>
          </div>
          ...
          <div className="text-center bg-gradient-to-br from-red-600/20 to-transparent backdrop-blur-sm rounded-2xl p-6 border border-red-600/30">
            ...
            <h4 className="text-white font-bold text-lg mb-2">Flexible Sessions</h4>
            <p className="text-gray-400 text-sm">Multiple time slots available daily</p>
          </div>
          ...
          <div className="text-center bg-gradient-to-br from-red-700/20 to-transparent backdrop-blur-sm rounded-2xl p-6 border border-red-700/30">
            ...
            <h4 className="text-white font-bold text-lg mb-2">Combat Experience</h4>
            <p className="text-gray-400 text-sm">Advanced arena and game modes</p>
          </div>
        </motion.div>
      </div>
    </section>

...
const arcadeHeroImages = {
  main: {
    heroBackground: "https://cdn.acsdev.in/FNF/699b44e528a60.jpg",
    arcadeHero:
      "https://https://cdn.acsdev.in/FNF/699b44e528a60.jpgh.com/photo-1542751371-adc38448a05e?w=600&h=800&fit=crop&auto=format",
    arcadeAction:
      "https://https://cdn.acsdev.in/FNF/699b44e528a60.jpgh.com/photo-1493711662062-fa541adb3fc8?w=600&h=800&fit=crop&auto=format",
  },
  floating: {
    arcade1:
      "https://https://cdn.acsdev.in/FNF/699b44e528a60.jpgh.com/photo-1511512578047-dfb367046420?w=200&h=150&fit=crop&auto=format",
    arcade2:
      "https://https://cdn.acsdev.in/FNF/699b44e528a60.jpgh.com/photo-1542751371-adc38448a05e?w=200&h=150&fit=crop&auto=format",
    arcade3:
      "https://https://cdn.acsdev.in/FNF/699b44e528a60.jpgh.com/photo-1493711662062-fa541adb3fc8?w=200&h=150&fit=crop&sat=50&auto=format",
    arcade4:
      "https://https://cdn.acsdev.in/FNF/699b44e528a60.jpgh.com/photo-1578662996442-48f60103fc96?w=200&h=150&fit=crop&hue=30&auto=format",
  },
};

export default function ArcadeGamesHero({
  banner,
  loading,
  activity,
  media,
  ...
  const heroBackground = landingImage || arcadeHeroImages.main.heroBackground;

  const heroTitle = activity?.name || "Arcade & Gaming";
  const heroDescription = activity?.description || "Ultimate Experience";

  // Use API gallery images or fallback to default images
  const floatingImages =
    galleryImages && galleryImages.length > 0
      ? galleryImages.slice(0, 4)
      : Object.values(arcadeHeroImages.floating);
  ...
  while (paddedImages.length < 4) {
    paddedImages.push(
      paddedImages[0] ||
        mainImage ||
        Object.values(arcadeHeroImages.floating)[0],
    );
  }
    ...
    <section className="relative w-full h-[50vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          ...
          onError={(e) => {
            e.target.src = arcadeHeroImages.main.heroBackground;
          }}
        />
        ...
        {/* Gaming Icons Silhouettes */}
        <div className="absolute inset-0 pointer-events-none opacity-5">
          <div className="absolute top-10 left-10 text-white text-6xl transform rotate-12">
            🎮
          </div>
          <div className="absolute top-32 left-32 text-white text-4xl transform -rotate-6">
            🕹️
          </div>
          <div className="absolute bottom-20 left-20 text-white text-5xl transform rotate-45">
            🎯
          </div>
          <div className="absolute top-20 right-96 text-white text-3xl transform -rotate-12">
            🏆
          </div>
          <div className="absolute bottom-32 right-80 text-white text-4xl transform rotate-30">
            ⚡
          </div>
        </div>
      ...
      <div className="absolute inset-0 pointer-events-none z-[18] hidden sm:block">
        <div className="w-full h-full scale-[0.85] sm:scale-[0.9] lg:scale-[0.95] origin-top-right">
          ...
          <div className="absolute inset-0 opacity-15">
            ...
            >
              <img
                src={paddedImages[0]}
                alt="Deep background arcade image"
                loading="lazy"
                className="w-full h-full rounded object-cover"
                onError={(e) => {
                  e.target.src = arcadeHeroImages.floating.arcade1;
                }}
              />
            </div>
            ...
            >
              <img
                ...
                className="w-full h-full rounded object-cover"
                onError={(e) => {
                  e.target.src = arcadeHeroImages.floating.arcade2;
                }}
              />
            </div>
            ...
            >
              <img
                ...
                className="w-full h-full rounded object-cover"
                onError={(e) => {
                  e.target.src = arcadeHeroImages.floating.arcade3;
                }}
              />
            </div>
            ...
            >
              <img
                ...
                className="w-full h-full rounded object-cover"
                onError={(e) => {
                  e.target.src = arcadeHeroImages.floating.arcade4;
                }}
              />
            </div>
          </div>
          ...
          <div className="absolute inset-0 opacity-25 scale-[0.85] origin-right">
            ...
            >
              <img
                src={paddedImages[0]}
                alt="Background depth arcade image"
                loading="lazy"
                className="w-full h-full rounded object-cover"
                onError={(e) => {
                  e.target.src = arcadeHeroImages.floating.arcade1;
          ...
          <div className="absolute inset-0 opacity-40">
            ...
            >
              <img
                src={paddedImages[1]}
                alt="Mid-depth floating arcade image"
                loading="lazy"
                className="w-full h-full rounded object-cover"
                onError={(e) => {
                  e.target.src = arcadeHeroImages.floating.arcade2;
          ...
          <div className="absolute inset-0 opacity-65">
            ...
            >
              <img
                src={paddedImages[0]}
                alt="Mid-foreground floating arcade image"
                loading="lazy"
          ...
          <div className="absolute inset-0">
            ...
            >
              <img
                src={paddedImages[0]}
                alt="Foreground floating arcade image"
                loading="lazy"
                className="w-full h-full rounded-lg object-cover"
                onError={(e) => {
                  e.target.src = arcadeHeroImages.floating.arcade1;
      ...
      {/* ROTATED TEXT */}
      <div
        className="hidden lg:block absolute right-[-120px] top-[130px] pointer-events-none z-[15]"
        style={{
      ...
      <style jsx>{`
        ...
        .popup-seq {
          animation: popup-seq 1s ease-out forwards;
        }

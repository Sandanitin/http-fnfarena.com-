...
const EventPackages = () => {
  ...
  const handleBookPackage = (pkg) => {
    // Redirect to external booking site instead of opening modal
    window.open('https://www.tickets99.com/', '_blank');
  };
  ...
  // Handle download brochure - open PDF modal
  ...
  return (
    <>
      ...
      {/* Booking Modal - Kept intact for potential future use */}
      <BookingModal
        isOpen={isModalOpen}
        onClose={closeModal}
      ...
      <PDFModal
        ...
        pdfUrl="https://cdn.acsdev.in/FNF/overall_menu.pdf"
        title="Event Packages Brochure"
      />
    </>
  );
};

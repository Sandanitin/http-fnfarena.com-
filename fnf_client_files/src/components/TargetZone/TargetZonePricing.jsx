...
export default function TargetZonePricing() {
  ...
  const packages = [
    {
      ...
      duration: "Per Person",
      features: [
        "1 HOUR TARGET SESSION",
        "30 ARROWS INCLUDED",
        "BASIC SAFETY GEAR",
        "BOW & EQUIPMENT RENTAL",
        "BEGINNER RANGE ACCESS",
        "SAFETY INSTRUCTION",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 text-xl leading-relaxed max-w-4xl mx-auto">
            Select the perfect precision package for your skill level. From beginner training to expert mastery,
            we have options for every archer and marksman seeking precision excellence.
          </p>
        </motion.div>
        ...
        >
          <h4 className="text-red-400 text-2xl font-bold mb-6 font-sansitaOne text-center">
            ⚠️ Important Range Rules
          </h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-200">
            <div className="space-y-3">
              <p className="text-sm leading-relaxed">
                <strong className="text-red-400">Age Limits:</strong> Minimum age 10 years. Under 14 requires adult supervision
              </p>
              <p className="text-sm leading-relaxed">
                <strong className="text-red-400">Safety Gear:</strong> Mandatory protective equipment provided and must be worn
              </p>
              <p className="text-sm leading-relaxed">
                <strong className="text-red-400">Range Rules:</strong> Follow instructor commands, no running on range
              </p>
            </div>
            <div className="space-y-3">
              <p className="text-sm leading-relaxed">
                <strong className="text-red-400">Equipment Care:</strong> Handle all equipment with care and respect
              </p>
              <p className="text-sm leading-relaxed">
                <strong className="text-red-400">Group Discounts:</strong> Special rates for teams of 8+ participants
              </p>
              <p className="text-sm leading-relaxed">
                <strong className="text-red-400">Weather Policy:</strong> Indoor range available during adverse weather
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="text-center bg-gradient-to-br from-red-500/20 to-transparent backdrop-blur-sm rounded-2xl p-6 border border-red-500/30">
            ...
            <p className="text-gray-400 text-sm">Professional safety equipment and certified instructors</p>
          </div>
          ...
          <div className="text-center bg-gradient-to-br from-red-600/20 to-transparent backdrop-blur-sm rounded-2xl p-6 border border-red-600/30">
            ...
            <h4 className="text-white font-bold text-lg mb-2">Extended Training</h4>
            <p className="text-gray-400 text-sm">Multiple target distances and precision challenges</p>
          </div>
          ...
          <div className="text-center bg-gradient-to-br from-red-700/20 to-transparent backdrop-blur-sm rounded-2xl p-6 border border-red-700/30">
            ...
            <p className="text-gray-400 text-sm">Professional bows, precision equipment, and range access</p>
          </div>
        </motion.div>
      </div>
    </section>

...
// Image object for target zone
const targetZoneHeroImages = {
  main: {
    heroBackground: heroBg,
    targetZoneHero: "https://cdn.acsdev.in/FNF/69ea459d75036.jpg",
    shootingRange: "https://cdn.acsdev.in/FNF/69e9ea3a85448.jpg"
  },
  floating: {
    gear1: "https://cdn.acsdev.in/FNF/69ea459d75036.jpg",
    gear2: "https://cdn.acsdev.in/FNF/69e9ea3a85448.jpg",
    gear3: "https://cdn.acsdev.in/FNF/69e9ea3b7ca95.jpg",
    gear4: "https://cdn.acsdev.in/FNF/69e9ea3c25db0.jpg"
  }
};

export default function TargetZoneHero({
  activity,
  media,
  mainImage,
  landingImage,
  ...
  const heroBackground = landingImage || targetZoneHeroImages.main.heroBackground;
  const floatingImages = galleryImages && galleryImages.length > 0
    ? galleryImages.slice(0, 4)
    : [
        targetZoneHeroImages.floating.gear1,
        targetZoneHeroImages.floating.gear2,
        targetZoneHeroImages.floating.gear3,
        targetZoneHeroImages.floating.gear4
      ];

  // Ensure we have at least 4 images for the floating effect
  const paddedImages = [...floatingImages];
  while (paddedImages.length < 4) {
    paddedImages.push(paddedImages[0] || mainImage || targetZoneHeroImages.floating.gear1);
  }
  ...
  return (
    <section className="relative w-full h-[50vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Precision Lines Pattern */}
        <div className="absolute top-1/4 left-1/4 opacity-10">
          <svg width="200" height="200" viewBox="0 0 200 200" className="text-red-400/30">
            <defs>
              <pattern id="precisionLines" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                <line x1="0" y1="10" x2="20" y2="10" stroke="currentColor" strokeWidth="2"/>
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#precisionLines)"/>
          </svg>
        </div>
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none z-[18] hidden sm:block">
        ...
        <div className="absolute inset-0 opacity-15">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Deep background target zone gear image"
              loading="lazy"
        ...
        <div className="absolute inset-0 opacity-25">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Background depth target zone gear image"
              loading="lazy"
              className="w-full h-full rounded object-cover"
            />
          </div>
        ...
        <div className="absolute inset-0 opacity-40">
          ...
          >
            <img
              src={paddedImages[1]}
              alt="Mid-depth floating target zone gear image"
              loading="lazy"
              className="w-full h-full rounded object-cover"
            />
          </div>
        ...
        <div className="absolute inset-0 opacity-65">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Mid-foreground floating target zone gear image"
              loading="lazy"
        ...
        <div className="absolute inset-0">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Foreground floating target zone gear image"
              loading="lazy"
              className="w-full h-full rounded-lg object-cover"
            />
          </div>
      ...
      {/* ROTATED TEXT */}
      <div
        className="hidden lg:block absolute right-[-150px] top-[180px] pointer-events-none z-[15]"
        style={{
        ...
        <div className="w-full lg:w-1/2">
          <h1 className="text-[60px] font-bold drop-shadow-lg font-josefin leading-tight font-sansitaOne">
            <span className="text-red-500 block">
              {activity?.name || 'Precision & Focus'}
            </span>
            <span className="text-white block">Own the Target. Own the Game.</span>
          </h1>
        </div>
      </div>

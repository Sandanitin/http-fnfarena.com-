...
// Default fallback images for rocker ejection features
const defaultRockerEjectionImages = {
  features: {
    safety: "https://cdn.acsdev.in/FNF/69ce517ac4f77.jpg",
    rocket: "https://cdn.acsdev.in/FNF/69ce50d13fcb2.jpg",
    group: "https://cdn.acsdev.in/FNF/69ce51797fe39.jpg",
    extreme: "https://cdn.acsdev.in/FNF/69ce50d13fcb2.jpg"
  }
};

export default function RockerEjectionFeatures({ features, details, galleryImages }) {
  ...
  const apiFeatures = details && details.length > 0 ? details.map((detail, index) => {
    ...
    if (galleryImages && galleryImages.length > 0) {
      ...
      const fallbackImages = Object.values(defaultRockerEjectionImages.features);
  ...
  }) : [
    {
      ...
      image: defaultRockerEjectionImages.features.safety,
      color: "red"
    },
    {
      title: "Rocket-Powered Launch",
      description: "Experience the incredible force of rocket propulsion as you're launched into the sky at breathtaking speeds.",
      image: defaultRockerEjectionImages.features.rocket,
      color: "red"
    },
    {
      title: "Elite Adventure Groups",
      description: "Perfect for thrill-seekers and adrenaline junkies. Share the ultimate rush with fellow adventure enthusiasts.",
      image: defaultRockerEjectionImages.features.group,
      color: "red"
    }
  ];

  const stats = [
    { number: "8,500+", label: "Rocket Riders", icon: Users },
    { number: "300+", label: "Daily Launches", icon: Zap },
    { number: "4.9★", label: "Thrill Rating", icon: Star },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-red-300 font-bold text-lg">Why Choose Our Rocket Ejection</span>
          </motion.div>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Blast off into the ultimate adrenaline experience with our revolutionary rocket ejection system
            that delivers unmatched thrills and cutting-edge safety technology.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 backdrop-blur-sm rounded-3xl p-8 border border-red-400/20">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <span className="text-yellow-400 font-bold">Extreme Thrill Champion</span>
              <Trophy className="w-6 h-6 text-yellow-400" />
            </div>

            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4 font-sansitaOne">
              Ready for Rocket-Powered Thrills?
            </h3>

            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Join the elite group of thrill-seekers who have experienced the ultimate rocket ejection adventure.
              Book your launch today and blast off into the experience of a lifetime.
            </p>

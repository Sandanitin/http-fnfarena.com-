...
export default function RockerEjectionPricing() {
  ...
  const packages = [
    {
      id: 1,
      name: "ROCKET STARTER",
      subtitle: "Perfect for First Launch!",
      icon: <Clock className="w-6 h-6" />,
      price: 2199,
      originalPrice: 2699,
      duration: "Per Person",
      features: [
        "ROCKET EJECTION EXPERIENCE",
        "GO-KARTING (5 LAPS)",
        "ARCHERY OR RIFLE SHOOTING",
        "FOOD (Buffet)",
        "Military-Grade Safety Equipment",
        "Professional Launch Guidance",
        "G-Force Training Session"
      ],
      popular: false,
      tier: "basic"
    },
    ...
    },
    {
      ...
      subtitle: "Complete Launch Experience!",
      ...
      features: [
        ...
        "ZIPLINE ROLLERCOASTER",
        "FOOD (Premium Buffet)",
        "Professional Rocket Video Package",
        "VIP Launch Experience",
        "Exclusive Rocket Merchandise"
      ],
      popular: false,
      tier: "premium"
    }
  ...
  return (
    <section id="rocket-pricing" className="relative  bg-[#1e2125] text-white py-16 px-4 sm:px-6 md:px-10 lg:px-20 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-full opacity-5">
          <svg width="100%" height="100%" viewBox="0 0 1200 800" className="text-white/10">
            <defs>
              <pattern id="rocketPricePattern" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
                <circle cx="100" cy="100" r="2" fill="currentColor"/>
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#rocketPricePattern)"/>
          </svg>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-white mt-4 text-sm md:text-base leading-relaxed max-w-3xl mx-auto">
            From explosive rocket ejection experiences to complete extreme sports packages, find the perfect launch
            that includes high-speed adventures, extreme activities, and premium dining.
          </p>
        </motion.div>
                ...
                <div className="pt-6 pb-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-400">
                    <p className="text-xs text-gray-300 text-center">
                      * Group launches available - Military-grade safety equipment included
                    </p>
                  </div>
                </div>
              </div>

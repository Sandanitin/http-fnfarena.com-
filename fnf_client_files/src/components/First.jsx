  ...
  return (
    <>
      ...
      >
        ...
        <motion.div
          className="flex flex-col md:flex-row z-10 gap-4 items-center w-full text-white"
        ...
        >
          ...
          >
            ...
            <div className="flex py-1 items-center bg-red-600 px-3 md:px-6 w-full overflow-hidden">
              <motion.div
              ...
              >
                {extendedIndustries.map((industry, index) => (
                  <React.Fragment key={`top-${index}`}>
                    ...
                    <span
                      className="text-xs md:text-sm mr-3 md:mr-4 whitespace-nowrap leading-none cursor-pointer hover:text-yellow-300 transition-colors duration-200"

...
export default function SkyRollerPricing() {
  ...
  const packages = [
    {
      id: 1,
      name: "SKY STARTER",
      subtitle: "Perfect for First Flight!",
      icon: <Clock className="w-6 h-6" />,
      price: 1899,
      originalPrice: 2299,
      duration: "Per Person",
      features: [
        "SKY ROLLER EXPERIENCE",
        "GO-KARTING (5 LAPS)",
        "ARCHERY OR RIFLE SHOOTING",
        "FOOD (Buffet)",
        "Advanced Safety Harnesses",
        "Professional Sky Guidance",
    ...
    },
    {
      ...
      features: [
        ...
        "FOOD (Buffet)",
        "Aerial Action Photography",
        "Priority Sky Booking",
        "Sky Rider Certificate"
      ],
      popular: true,
      tier: "group"
    },
    {
      id: 3,
      name: "ULTIMATE SKY",
      subtitle: "Complete Sky Experience!",
      ...
      features: [
        ...
        "ROCKET EJECTION",
        "FOOD (Premium Buffet)",
        "Professional Sky Video Package",
        "VIP Sky Experience",
        "Exclusive Sky Merchandise"
      ],
      popular: false,
      tier: "premium"
    }
  ...
  return (
    <section id="sky-pricing" className="relative  bg-[#1e2125] text-white py-16 px-4 sm:px-6 md:px-10 lg:px-20 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-full opacity-5">
          <svg width="100%" height="100%" viewBox="0 0 1200 800" className="text-white/10">
            <defs>
              <pattern id="skyPricePattern" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
                <circle cx="100" cy="100" r="2" fill="currentColor"/>
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#skyPricePattern)"/>
          </svg>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-white text-[28px] md:text-[32px] font-sansitaOne mb-2">
            Choose Your Sky Roller Experience
          </h2>
          ...
          <p className="text-white mt-4 text-sm md:text-base leading-relaxed max-w-3xl mx-auto">
            From breathtaking sky roller adventures to complete aerial experiences, find the perfect flight
            that includes high-altitude thrills, adventure activities, and gourmet dining.
          </p>
        </motion.div>
                ...
                <div className="pt-6 pb-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-400">
                    <p className="text-xs text-gray-300 text-center">
                      * Group flights available - Advanced safety harnesses included
                    </p>
                  </div>
                </div>
              </div>

...
export default function SkyRollerHero({
  activity,
  media,
  mainImage,
  landingImage,
  ...
  const heroBackground = landingImage || "https://cdn.acsdev.in/FNF/69d3782f0a5a9.jpg";
  const floatingImages = galleryImages && galleryImages.length > 0
    ? galleryImages.slice(0, 4)
    : [
        "https://cdn.acsdev.in/FNF/69d3782e3d2fa.jpg",
        "https://cdn.acsdev.in/FNF/69d3782f0a5a9.jpg",
        "https://cdn.acsdev.in/FNF/69d3782e3d2fa.jpg",
        "https://cdn.acsdev.in/FNF/69d3782f0a5a9.jpg"
      ];
  ...
  return (
    <section className="relative w-full h-[50vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroBackground}
          alt="Sky roller adventure background"
          loading="lazy"
      ...
      <div className="absolute inset-0 pointer-events-none z-[18] scale-[0.85] origin-right hidden sm:block">
        ...
        <div className="absolute inset-0 opacity-15">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Deep background sky roller image"
              loading="lazy"
        ...
        <div className="absolute inset-0 opacity-25">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Background depth sky roller image"
              loading="lazy"
              className="w-full h-full rounded object-cover"
            />
          </div>
        ...
        <div className="absolute inset-0 opacity-40">
          ...
          >
            <img
              src={paddedImages[1]}
              alt="Mid-depth floating sky roller image"
              loading="lazy"
              className="w-full h-full rounded object-cover"
            />
          </div>
        ...
        <div className="absolute inset-0 opacity-65">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Mid-foreground floating sky roller image"
              loading="lazy"
        ...
        <div className="absolute inset-0">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Foreground floating sky roller image"
              loading="lazy"
              className="w-full h-full rounded-lg object-cover"
            />
          </div>
      ...
      {/* ROTATED TEXT */}
      <div
        className="hidden lg:block absolute right-[-90px] top-[90px] pointer-events-none z-[15]"
        style={{
        ...
        <div className="w-full lg:w-1/2">
          <h1 className="text-[60px] font-bold drop-shadow-lg font-josefin leading-tight font-sansitaOne">
            <span className="text-red-400 block">
              {activity?.name || 'Sky Roller'}
            </span>
            <span className="text-white block">Ultimate Thrills</span>
          </h1>
        </div>
      </div>

...
export default function ZiplineHero({
  activity,
  media,
  mainImage,
  landingImage,
  ...
  const heroBackground = landingImage || "https://cdn.acsdev.in/FNF/69d3ea36e6d05.jpg";
  const floatingImages = galleryImages && galleryImages.length > 0
    ? galleryImages.slice(0, 4)
    : [
        "https://cdn.acsdev.in/FNF/69d3ea36e6d05.jpg",
        "https://cdn.acsdev.in/FNF/699b3f2230e9c.jpg",
        "https://cdn.acsdev.in/FNF/69d3ea36e6d05.jpg",
        "https://cdn.acsdev.in/FNF/699b3f2230e9c.jpg"
      ];
  ...
  return (
    <section className="relative w-full h-[50vh] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroBackground}
          alt="Zipline adventure background"
          loading="lazy"
      ...
      <div className="absolute inset-0 pointer-events-none z-[18] hidden sm:block">
        ...
        <div className="absolute inset-0 opacity-15">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Deep background zipline image"
              loading="lazy"
        ...
        <div className="absolute inset-0 opacity-25">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Background depth zipline image"
              loading="lazy"
              className="w-full h-full rounded object-cover"
            />
          </div>
        ...
        <div className="absolute inset-0 opacity-40">
          ...
          >
            <img
              src={paddedImages[1]}
              alt="Mid-depth floating zipline image"
              loading="lazy"
              className="w-full h-full rounded object-cover"
            />
          </div>
        ...
        <div className="absolute inset-0 opacity-65">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Mid-foreground floating zipline image"
              loading="lazy"
        ...
        <div className="absolute inset-0">
          ...
          >
            <img
              src={paddedImages[0]}
              alt="Foreground floating zipline image"
              loading="lazy"
              className="w-full h-full rounded-lg object-cover"
            />
          </div>
        ...
        <div className="w-full lg:w-1/2">
          <h1 className="text-[60px] font-bold drop-shadow-lg font-josefin leading-tight font-sansitaOne">
            <span className="text-red-400 block">
              {activity?.name || 'Zipline Roller Coaster'}
            </span>
            <span className="text-white block">Adventure & Thrills</span>
          </h1>
        </div>
      </div>

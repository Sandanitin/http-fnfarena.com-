...
export default function ZiplinePricing() {
  ...
  return (
    <section id="zipline-pricing" className="relative  bg-[#1e2125] text-white py-16 px-4 sm:px-6 md:px-10 lg:px-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-white text-[28px] md:text-[32px] font-sansitaOne mb-2">
            Choose Your Zipline Experience
          </h2>
          ...
          <p className="text-white mt-4 text-sm md:text-base leading-relaxed max-w-3xl mx-auto">
            From thrilling zipline adventures to complete gaming experiences, find the perfect package

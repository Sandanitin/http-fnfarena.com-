...
import { X, ChevronLeft, ChevronRight, Camera, Heart, Share2, Download, Play, Pause, Volume2, VolumeX } from "lucide-react";

export default function ZiplineGallery({ galleryImages, videos, metrics }) {
  ...
  // Use passed metrics
  const ziplineMetrics = metrics;

  // Fallback images when API data is not available
  const fallbackImages = [
    {
      src: "https://cdn.acsdev.in/FNF/69d3ea36e6d05.jpg",
      alt: "Zipline adventure through mountain landscape",
      title: "Mountain Peak Experience",
      type: "image"
    },
    {
      src: "https://cdn.acsdev.in/FNF/699b3f2230e9c.jpg",
      alt: "High-speed zipline action shot",
      title: "High-Speed Thrills",
      type: "image"
    },
    {
      src: "https://cdn.acsdev.in/FNF/69d3ea36e6d05.jpg",
      alt: "Scenic mountain views from zipline",
      title: "Breathtaking Views",
      type: "image"
    },
    {
      src: "https://cdn.acsdev.in/FNF/699b3f2230e9c.jpg",
      alt: "Group zipline adventure",
      title: "Team Adventures",
      type: "image"
    },
    {
      src: "https://cdn.acsdev.in/FNF/69d3ea36e6d05.jpg",
      alt: "Sunset zipline experience",
      title: "Golden Hour Flight",
      type: "image"
    },
    {
      src: "https://cdn.acsdev.in/FNF/699b3f2230e9c.jpg",
      alt: "Forest canopy zipline",
      title: "Forest Canopy Tour",
      type: "image"
    },
    {
      src: "https://cdn.acsdev.in/FNF/69d3ea36e6d05.jpg",
      alt: "Professional zipline equipment",
      title: "Safety First",
      type: "image"
    }
  ];
  ...
  const categories = ["Adventure", "Thrills", "Views", "Team", "Experience", "Safety"];
  const titles = [
  ...
  const processedImages = React.useMemo(() => {
    if (galleryImages && galleryImages.length > 0) {
      return galleryImages.map((imageUrl, index) => ({
        src: imageUrl,
        alt: `Zipline adventure image ${index + 1}`,
  ...
  const processedVideos = React.useMemo(() => {
    // console.log('Processing videos in ZiplineGallery:', videos);
    ...
    if (videos && videos.length > 0) {
      return videos.map((video, index) => {
        ...
        return {
          ...
          isYouTube,
          alt: `Zipline video ${index + 1}`,
          title: video.label && video.label[0] ? video.label[0] : `Zipline Video ${index + 1}`,
          category: categories[index % categories.length],
          likes: Math.floor(Math.random() * 200) + 150,
          type: "video"
        };
  ...
  const metricsData = React.useMemo(() => {
    const fallbackMetrics = [
      { value: "500", label: "Adventures Daily", color: "red" },
      { value: "15", label: "Zipline Tracks", color: "amber" },
    ...
    metricsMapping.forEach((mapping, index) => {
      const value = ziplineMetrics[mapping.field];
      const suffix = ziplineMetrics[mapping.suffix] || '';
  ...
  return (
    <section id="zipline-gallery" className="relative py-20 bg-gradient-to-br from-gray-900 via-black to-gray-800 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-red-500 font-bold">Zipline Gallery</span>
          </motion.div>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Relive the breathtaking moments and stunning views from our zipline roller experience.
            Every flight is a photo opportunity waiting to happen.
          </p>
        </motion.div>
                    ...
                    {media.isYouTube ? (
                      <div className="relative w-full h-full">
                        <img
                          ...
                          onError={(e) => {
                            e.target.src = "https://cdn.acsdev.in/FNF/69d3ea36e6d05.jpg";
                          }}
                        />
                      </div>
                    ) : (
        ...
        >
          <div className="bg-red-500/10 backdrop-blur-sm rounded-3xl p-8 border border-red-400/20">
            ...
            <p className="text-gray-300 mb-2 max-w-2xl mx-auto">
              Book your zipline roller experience today and capture memories that will last a lifetime.
                  ...
                  <>
                    {selectedMedia.isYouTube ? (
                      <iframe
                        ...
                        allowFullScreen
                        title={selectedMedia?.title || "Zipline Video"}
                      />
                    ) : (
                      <video

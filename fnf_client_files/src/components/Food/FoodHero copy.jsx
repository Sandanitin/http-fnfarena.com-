...
export default function FoodHero() {
  ...
  const handleViewMenu = () => {
    if (!menuLoading && menuDocuments.cafe_menu) {
      window.open(menuDocuments.cafe_menu, '_blank');
    }
  };
            ...
            >
              ...
              >
                <button
                  ...
                  className="group bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-3 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <Download className="w-5 h-5" />
                  {menuLoading ? 'Loading Menu...' : 'View Full Menu'}

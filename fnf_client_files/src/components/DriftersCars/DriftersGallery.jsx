...
export default function DriftersGallery({ galleryImages, videos, metrics }) {
  ...
  // Use passed metrics
  const driftersMetrics = metrics;

  // Fallback images when API data is not available
  const fallbackImages = [
    {
      src: "https://cdn.acsdev.in/FNF/698d71d0d00d9.jpg",
      alt: "High-speed drift cars on outdoor track",
      title: "Drift Racing",
      category: "Racing",
      likes: 245,
      type: "image"
    ...
    {
      src: "https://cdn.acsdev.in/FNF/698d71d0d00d9.jpg",
      alt: "Racing competition with multiple cars",
    ...
    {
      src: "https://cdn.acsdev.in/FNF/698d71d0d00d9.jpg",
      alt: "Outdoor racing facility with natural lighting",
    ...
    {
      src: "https://cdn.acsdev.in/FNF/698d71d0d00d9.jpg",
      alt: "Professional racing track with timing system",
  ...
  const categories = ["Racing", "Fun", "Competition", "Facility", "Family", "Professional"];
  const titles = [
    "Drift Racing",
    "Drifters",
    "Racing Competition",
  ...
  const processedVideos = React.useMemo(() => {
    if (videos && videos.length > 0) {
      return videos.map((video, index) => {
        const baseVideo = {
          alt: `Racing video ${index + 1}`,
          title: video.label && video.label[0] ? video.label[0] : `Racing Video ${index + 1}`,
          category: categories[index % categories.length],
          likes: Math.floor(Math.random() * 200) + 150,
  ...
  const metricsData = React.useMemo(() => {
    const fallbackMetrics = [
      { value: "12", label: "Racing Cars", color: "red" },
      { value: "2", label: "Racing Tracks", color: "amber" },
      { value: "10", label: "Hours Daily", color: "orange" },
      { value: "100%", label: "Outdoor Fun", color: "red" }
    ];
    ...
    metricsMapping.forEach((mapping, index) => {
      const value = driftersMetrics[mapping.field];
      const suffix = driftersMetrics[mapping.suffix] || '';
  ...
  return (
    <section id="DriftersGallery" className="relative bg-gradient-to-tr from-gray-900 via-gray-800 to-black text-white py-20 px-4 sm:px-6 md:px-10 lg:px-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 text-xl leading-relaxed max-w-4xl mx-auto">
            Explore our collection of thrilling racing moments, from high-speed drifts to family fun,
            captured at FNF Arena's premier outdoor racing facility.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-br from-red-500/20 to-red-600/10 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-red-500/30">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h3 className="text-4xl font-bold font-sansitaOne text-white">Experience the Action Live!</h3>
              <Zap className="w-8 h-8 text-red-400" />
            </div>
            <p className="text-gray-200 mb-8 max-w-2xl mx-auto text-lg">
              Ready to create your own racing memories? Book your session today and become part of our racing gallery.
            </p>

...
use App\Models\EventTimeSlotModel;

class EventTimeSlotsController extends ResourceController
{
    protected $model;

    public function __construct()
    {
        $this->model = new EventTimeSlotModel();
    }
    ...
    public function update($id = null)
    {
        ...
        $event_type_id = $input['event_type_id'] ?? $existing['event_type_id'];

...
use App\Models\EventsReviewsModel;
use App\Libraries\R2Upload;

class EventsReviewsController extends ResourceController
{
    protected $model;

    public function __construct()
    {
        $this->model = new EventsReviewsModel();
    }
    ...
    public function update($id = null)
    {
        ...
        $updateData = [
            'event_id'           => $data['event_id'] ?? $review['event_id'],
            ...
            'occasion'           => $data['occasion'] ?? $review['occasion'],
            'place'              => $data['place'] ?? $review['place'],
            'reviewer_image'     => $imageName,
